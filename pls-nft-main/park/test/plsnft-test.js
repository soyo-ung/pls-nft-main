...
const PLSnft = require("../artifacts/contracts/PLSnft.sol/PLSnft.json");

const ERC721IFID = "0x80ac58cd";
const ERC165IFID = "0x01ffc9a7";
// const ERC721ReceivedIFID = "0x150b7a02";

const tokenURI1 = "ipfs://bafyreiho25kz6mfpsuv67oizlysyzsxztyix63izlxdgcx6me547e55bmu/metadata.json";
const tokenURI2 = "ipfs://bafyreihqy5ahqdgvzykr2jofmjjbnflfngg5fchj7a7ft4cidl5d6ots7y/metadata.json";
const tokenURI3 = "ipfs://bafyreiedfg27imtttxwh3455pgaqu2jnc6le7fwuavakhsitf6kux6aufy/metadata.json";


describe("PLS NFT Test", async () => {
    
    const [deployer, james, mary, approved] = provider.getWallets();
    
    before(async () => {
        
        this.instance = await deployContract(deployer, PLSnft);
